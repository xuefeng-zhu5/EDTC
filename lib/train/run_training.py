...
def main():
    ...
    parser.add_argument('--script', type=str, default='uavtrack_eh', help='Name of the train script.') #uavtrack / uavtrack_eh
    ...
    parser.add_argument('--save_dir', type=str,
                        default='/vol/research/facer2vm_tracking/people/xuefeng/2023AntiUAV/2023_NIPS_Experiments/EDTC/lib/train',
    ...
    parser.add_argument('--stage1_model', type=str,
                        default='/vol/research/facer2vm_tracking/people/xuefeng/2023AntiUAV/2023_NIPS_Experiments/EDTC/pretrained_models/UAVTrackEH.pth.tar',
                        help='stage1 model used to train EH.')
